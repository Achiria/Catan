                        ...
                        if (Board.table[i][j].getCrease(creases[k]).getOcc())
                        {
                            ...
                            else if (k == 1)
                            {
                                ...
                                if (i % 2 == 0)
                                {
                                    ...
                                    path.append(toDraw, false);
                                    t.rotate(-1, x[1] + (i * xDiff) + xOffset - 20, y[1] + (j * yDiff) - yOffset - 35);
                                    path.transform(t);
                                }
                                ...
                                else
                                {
                                    ...
                                    path.append(toDraw, false);
                                    t.rotate(-1, x[1] + (i * xDiff) + xOffset - 20, y[1] + (j * yDiff) - yOffset - 35 + oddOffset);
                                    path.transform(t);
                                }
                            ...
                            else if (k == 2)
                            {
                                ...
                                if (i % 2 == 0)
                                {
                                    ...
                                    path.append(toDraw, false);
                                    t.rotate(1, x[1] + (i * xDiff) + xOffset - 20, y[2] + (j * yDiff) - yOffset - 35);
                                    path.transform(t);
                                ...
                                else
                                {
                                    ...
                                    path.append(toDraw, false);
                                    t.rotate(1, x[1] + (i * xDiff) + xOffset - 20, y[2] + (j * yDiff) - yOffset - 35 + oddOffset);
                                    path.transform(t);
                                }
